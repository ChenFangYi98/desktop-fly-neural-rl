...
> **DesktopFly Neural RL 已加入 Windows 三维连接组强化学习实验室。** 中文快速开始、训练、生态部署与 ROS 2 文档见 [README.zh-CN.md](README.zh-CN.md)。

![Connectome RL training studio](docs/images/training-studio.png)
